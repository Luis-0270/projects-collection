...
public class ItemCountTopN {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<ItemCount> aggregate = keyedStream.window(SlidingEventTimeWindows.of(Time.hours(1), Time.minutes(5)))
                .aggregate(new InemCountAggFunc(), new ItemCountWindowFunc());
    ...
    public static class InemCountAggFunc implements AggregateFunction<Tuple2<Long, Integer>, Integer, Integer> {
