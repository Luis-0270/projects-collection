...
import com.ludonghua.use.bean.AdsClickLog;
import com.ludonghua.use.bean.AdsCount;
...
public class AdCount {
    public static void main(String[] args) throws Exception {
        ...
        WatermarkStrategy<AdsClickLog> adsClickLogWatermarkStrategy = WatermarkStrategy.<AdsClickLog>forMonotonousTimestamps().withTimestampAssigner(new SerializableTimestampAssigner<AdsClickLog>() {
            @Override
        ...
        SingleOutputStreamOperator<AdsCount> result = keyedStream.window(SlidingEventTimeWindows.of(Time.hours(1), Time.seconds(5)))
    ...
    public static class AdCountWindowFunc implements WindowFunction<Integer, AdsCount, String, TimeWindow> {

        @Override
        public void apply(String s, TimeWindow window, Iterable<Integer> input, Collector<AdsCount> out) throws Exception {
            Integer count = input.iterator().next();
            out.collect(new AdsCount(s, window.getEnd(), count));
        }
    }
    ...
    public static class BlackListProcessFunc extends KeyedProcessFunction<String, AdsClickLog, AdsClickLog> {
        ...
        private ValueState<Boolean> isSendSate;
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            isSendSate = getRuntimeContext().getState(new ValueStateDescriptor<Boolean>("is-end", Boolean.class));
        }
        ...
        public void processElement(AdsClickLog value, Context ctx, Collector<AdsClickLog> out) throws Exception {
            ...
            Boolean isSend = isSendSate.value();
