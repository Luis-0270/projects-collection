...
import com.ludonghua.use.bean.ApacheLog;
import com.ludonghua.use.bean.UrlCount;
...
/**
 * Author Luis
 * DATE 2022-06-08 23:32
 */
public class HotUrl2 {
    public static void main(String[] args) throws Exception {
        ...
        WatermarkStrategy<ApacheLog> apacheLogWatermarkStrategy = WatermarkStrategy.<ApacheLog>forBoundedOutOfOrderness(Duration.ofSeconds(2)).withTimestampAssigner(new SerializableTimestampAssigner<ApacheLog>() {
            @Override
