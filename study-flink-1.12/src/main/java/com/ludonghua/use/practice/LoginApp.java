...
public class LoginApp {
    ...
    public static class LoginKeyedProcessFunc extends KeyedProcessFunction<Long, LoginEvent, String> {
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            valueState = getRuntimeContext().getState(new ValueStateDescriptor<Long>("ts-state", Long.class));
        }
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<String> out) throws Exception {
            ...
            if (loginEvents.size() >= count) {
                ...
                out.collect(first.getUserId() + "用户在" + first.getEventTime() + "到" +
                        last.getEventTime() + "之间，连续登陆失败了" + loginEvents.size() + "次");
            }
